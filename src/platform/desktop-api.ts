...
export interface VehicleSchema { objectTypes: string[]; attributes: Record<string, string[]> }
...
export const desktop = {
  ...
  scanFolder: (path: string, kind: ResourceKind) => invoke<Record<string, string>>('scan_resource_folder', { path, kind }),
